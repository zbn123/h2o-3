...
def h2ogroup_by_GroupBy_get_frame():
    """
    Python API test: h2o.group_by.GroupBy.get_frame()
...
if __name__ == "__main__":
    pyunit_utils.standalone_test(h2ogroup_by_GroupBy_get_frame())
else:
    h2ogroup_by_GroupBy_get_frame()
